...
var ShipmentUpdate = /** @class */ (function () {
    function ShipmentUpdate(id, shipmentData) {
        this.tempProp = new ShipmentSearchIndex();
        this.id = id;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.tempProp.updateShipment(id, shipmentData)];
                    case 1:
                        data = _a.sent();
...
var obj = new ShipmentUpdate(id, shipmentData);
